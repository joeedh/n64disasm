...
export let init = () => {
  ...
  exports.MemEditor = class MemEditor extends ScreenArea.Area {
    ...
    copy() {
      let ret = document.createElement("memedit-area-x");
      ret.ctx = this.ctx;
    ...
    static define() { return {
      tagname  : "memedit-area-x",
      areaname : "memedit_area",
      uiname   : "Memory Editor"
    };}
  }
  
  ScreenArea.Area.register(exports.MemEditor);
};
